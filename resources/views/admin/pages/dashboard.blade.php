                        ...
                        <div class="card-body pt-0 pb-5">
                            <table class="table card-table table-responsive table-responsive-large"
                                ...
                                <tr>
                                    <td>{{$list_order->id}}</td>
                                    <td>
                                        <a class="text-dark" href="#">{{$list_order->amount}}</a>
                                    </td>
                                    <td class="d-none d-lg-table-cell">1 Unit</td>
                                    <td class="d-none d-lg-table-cell">Oct 20, 2018</td>
                                    <td class="d-none d-lg-table-cell">{{$list_order->amount}}</td>
                                    <td>
                                        <span class="badge badge-success">{{$list_order->recived}}</span>
                                    </td>
                                    <td class="text-right">
                                        <div class="dropdown show d-inline-block widget-dropdown">
                                        ...
                                        <div class="media">
                                            <div class="media-image mr-3 rounded-circle">
                                                <a href="profile.html"><img
                                                        ...
                                                        src="{{('admin/assets/img/user/u1.jpg')}}"
                                    ...
                                    <td>
                                        <div class="media">
                                            <div class="media-image mr-3 rounded-circle">
                                                <a href="profile.html"><img
                                                        class="profile-img rounded-circle w-45"
                                                        src="{{('admin/assets/img/user/u2.jpg')}}"
                                                        alt="customer image"></a>
                                            </div>
                                            <div class="media-body align-self-center">
                                                <a href="profile.html">
                                    ...
                                    <td>
                                        <div class="media">
                                            <div class="media-image mr-3 rounded-circle">
                                                <a href="profile.html"><img
                                                        class="profile-img rounded-circle w-45"
                                                        src="{{('admin/assets/img/user/u3.jpg')}}"
                                                        alt="customer image"></a>
                                            </div>
                                            <div class="media-body align-self-center">
                                                <a href="profile.html">
                                    ...
                                    <td>
                                        <div class="media">
                                            <div class="media-image mr-3 rounded-circle">
                                                <a href="profile.html"><img
                                                        class="profile-img rounded-circle w-45"
                                                        src="{{('admin/assets/img/user/u4.jpg')}}"
                                                        alt="customer image"></a>
                                            </div>
                                            <div class="media-body align-self-center">
                                                <a href="profile.html">
                                    ...
                                    <td>
                                        <div class="media">
                                            <div class="media-image mr-3 rounded-circle">
                                                <a href="profile.html"><img
                                                        class="profile-img rounded-circle w-45"
                                                        src="{{('admin/assets/img/user/u5.jpg')}}"
                                                        alt="customer image"></a>
                                            </div>
                                            <div class="media-body align-self-center">
                                                <a href="profile.html">
