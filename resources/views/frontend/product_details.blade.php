                    ...
                    <div class="product-offer">
                      ...
                      <div class="offer-contain">
                        ...
                        <ul class="offer-sider">
                          ...
                          <li>
                            <span class="code-lable">@lang('product_details.OFFER5')</span>
                            <div>
                              <h5>@lang('product_details.Bank Offer5% Unlimited Cashback on bideal sbi banck Credit Card')</h5>
                              <p>@lang('product_details.Use code "OFFER5" Min. Cart Value $99 | Max. Discount $5')</p>
                            </div>
                          </li>
                        </ul>
